...
public class AddController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String bookString = book_name + "<" + book_author + "<" + book_year;
            System.out.println("add " + bookString);
            if (Books.getBooks().addBook(bookString)) {
                out.print("<script>alert('Add success!');</script>");
            } else {
                out.print("<script>alert('Unexpected Error happened. Add failed!');</script>");
            }
